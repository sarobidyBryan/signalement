...
public class ReportsSummaryService {
    ...
    public Map<String, Object> getSummaryForStatus(String statusCode) {
        ...
        summary.put("totalTreated", totalTreated);
    ...
    public Map<String, Object> getGlobalSummary() {
        ...
        for (Report report : allReports) {
            ...
            rmap.put("id", report.getId());
            rmap.put("description", report.getDescription());
            rmap.put("latitude", report.getLatitude());
            rmap.put("longitude", report.getLongitude());
            ...
            if (report.getUser() != null) {
                ...
                rmap.put("user", userMap);
            }

            // include status information so frontend can color markers
            if (report.getStatus() != null) {
                Map<String, Object> statusMap = new HashMap<>();
                statusMap.put("statusCode", report.getStatus().getStatusCode());
                statusMap.put("label", report.getStatus().getLabel());
                rmap.put("status", statusMap);
                // also expose convenient flat fields
                rmap.put("statusCode", report.getStatus().getStatusCode());
                rmap.put("statusLabel", report.getStatus().getLabel());
            }
